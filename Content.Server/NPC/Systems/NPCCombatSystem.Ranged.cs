using System.Numerics; // ADT-edit
...
public sealed partial class NPCCombatSystem
{
    ...
    private void UpdateRanged(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var comp, out var xform))
        {
            ...
            var oldInLos = comp.TargetInLOS; // ADT-edit
            ...
            if (comp.LOSAccumulator < 0f)
            {
                ...
                comp.TargetInLOS = _interaction.InRangeUnobstructed(comp.Owner, comp.Target, distance + 0.1f) &&  // ADT-edit
                                   (!comp.Advanced | _interaction.InRangeUnobstructed(comp.Owner, new MapCoordinates(targetSpot, xform.MapID), distance + 0.1f));  // ADT-edit
            }
            ...
            if (_mapManager.TryFindGridAt(xform.MapID, xt, out var gridUid, out var mapGrid))  // ADT-edit
            {
